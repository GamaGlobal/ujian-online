...
const SOAL = [
  ...
  { bagian: "Penalaran Matematika", nomor: 4, soal: "Perhatikan grafik berikut! Berdasarkan grafik jumlah penumpang di bawah, pernyataan berikut yang paling tepat adalah ...", gambar: "https://imgur.com/7xSySqT", pilihan: ["A. Jumlah penumpang September 2021 lebih dari 2x lipat penumpang Agustus 2021.", "B. Selisih jumlah penumpang Desember 2020 dan September 2021 sebanyak 1,96 juta penumpang.", "C. Jumlah penumpang Oktober 2020 meningkat 700 ribu dibanding tahun sebelumnya.", "D. Penumpang paling sedikit 995.400 terjadi pada bulan Juni 2020."], kunci: "B" },
  ...
  { bagian: "Penalaran Matematika", nomor: 13, soal: "Tabel nilai Matematika kelas 9C: Nilai 5(3 siswa), 6(7), 7(8), 8(4), 9(3), 10(1). Berapa jumlah siswa yang nilainya di bawah rata-rata?", gambar: "https://imgur.com/hvfBeUx", pilihan: ["A. 18", "B. 10", "C. 3", "D. 22"], kunci: "B" },
  ...
  { bagian: "Literasi Keislaman", nomor: 2, soal: "Perhatikan hadis berikut! Dalam hadis yang tercantum di bawah, terdapat amalan salat sunah ghairu muakkad, yaitu ...", gambar: "https://imgur.com/svBMoqE", pilihan: ["A. Salat Istisqa'", "B. Salat Idul Fitri", "C. Salat Idul Adha", "D. Salat Istikharah"], kunci: "A" },
  { bagian: "Literasi Keislaman", nomor: 3, soal: "Perhatikan dalil berikut! Dalil di bawah menyebutkan dua bangkai yang halal untuk dimakan, yaitu ...", gambar: "https://imgur.com/ZKpNaVg", pilihan: ["A. Ikan dan belalang", "B. Kambing dan sapi", "C. Unta dan sapi", "D. Ikan dan unta"], kunci: "A" },
